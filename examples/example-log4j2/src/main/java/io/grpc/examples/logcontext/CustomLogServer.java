...
/**
 * A server like {@link io.grpc.examples.helloworld.HelloWorldServer} that logs through Log4j 2.
 *
 * <p>It installs {@link HeaderServerInterceptor}, which puts a request id and the client name into
...
public class CustomLogServer {
  ...
  private static class GreeterImpl extends GreeterGrpc.GreeterImplBase {
    ...
    public void sayHello(HelloRequest req, StreamObserver<HelloReply> responseObserver) {
      // The ThreadContext set by HeaderServerInterceptor is still in place here, so this outputs
      // something like:
      // 2026/09/14 15:22:12:686 PDT INFO  CustomLogServer - Got a request
