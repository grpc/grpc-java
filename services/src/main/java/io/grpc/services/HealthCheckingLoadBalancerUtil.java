 ...
 *
 * @deprecated Use {@link io.grpc.protobuf.services.HealthCheckingLoadBalancerUtil} instead.
 */
@Deprecated
@ExperimentalApi("https://github.com/grpc/grpc-java/issues/5025")
public class HealthCheckingLoadBalancerUtil {
  ...
  public static LoadBalancer newHealthCheckingLoadBalancer(
    ...
    return io.grpc.protobuf.services.HealthCheckingLoadBalancerUtil.newHealthCheckingLoadBalancer(
        factory, helper);
  }
}
