...
import io.grpc.stats.Channelz.RootChannelList;
import io.grpc.stats.Channelz.ServerList;
...
public final class ChannelzProtoUtilTest {
  ...
  public void socketSecurityOther() throws Exception {
    ...
    socket.security
        = new Channelz.Security(
            new Channelz.OtherSecurity("other_security", packed));
    assertEquals(
  ...
  public void toGetTopChannelsResponse() {
    ...
    assertEquals(
        ...
        ChannelzProtoUtil.toGetTopChannelResponse(
            new RootChannelList(
                Collections.<Instrumented<ChannelStats>>emptyList(), true)));
    ...
    assertEquals(
        ...
        ChannelzProtoUtil.toGetTopChannelResponse(
            new RootChannelList(
                ImmutableList.<Instrumented<ChannelStats>>of(channel), false)));
    ...
    assertEquals(
        ...
        ChannelzProtoUtil.toGetTopChannelResponse(
            new RootChannelList(
                ImmutableList.<Instrumented<ChannelStats>>of(channel), true)));
  ...
  public void toGetServersResponse() {
    ...
    assertEquals(
        ...
        ChannelzProtoUtil.toGetServersResponse(
            new ServerList(
                ImmutableList.<Instrumented<ServerStats>>of(server, server2), true)));
  }
