...
public final class TestServiceGrpc_1_14_0 {

  private TestServiceGrpc_1_14_0() {}
  ...
  public static io.grpc.MethodDescriptor<io.grpc.testing.compiler.Test.SimpleRequest,
    ...
    if ((getUnaryCallMethod = TestServiceGrpc_1_14_0.getUnaryCallMethod) == null) {
      synchronized (TestServiceGrpc_1_14_0.class) {
        if ((getUnaryCallMethod = TestServiceGrpc_1_14_0.getUnaryCallMethod) == null) {
          TestServiceGrpc_1_14_0.getUnaryCallMethod = getUnaryCallMethod = 
  ...
  public static io.grpc.MethodDescriptor<io.grpc.testing.compiler.Test.StreamingOutputCallRequest,
    ...
    if ((getStreamingOutputCallMethod = TestServiceGrpc_1_14_0.getStreamingOutputCallMethod) == null) {
      synchronized (TestServiceGrpc_1_14_0.class) {
        if ((getStreamingOutputCallMethod = TestServiceGrpc_1_14_0.getStreamingOutputCallMethod) == null) {
          TestServiceGrpc_1_14_0.getStreamingOutputCallMethod = getStreamingOutputCallMethod = 
  ...
  public static io.grpc.MethodDescriptor<io.grpc.testing.compiler.Test.StreamingInputCallRequest,
    ...
    if ((getStreamingInputCallMethod = TestServiceGrpc_1_14_0.getStreamingInputCallMethod) == null) {
      synchronized (TestServiceGrpc_1_14_0.class) {
        if ((getStreamingInputCallMethod = TestServiceGrpc_1_14_0.getStreamingInputCallMethod) == null) {
          TestServiceGrpc_1_14_0.getStreamingInputCallMethod = getStreamingInputCallMethod = 
  ...
  public static io.grpc.MethodDescriptor<io.grpc.testing.compiler.Test.StreamingOutputCallRequest,
    ...
    if ((getFullBidiCallMethod = TestServiceGrpc_1_14_0.getFullBidiCallMethod) == null) {
      synchronized (TestServiceGrpc_1_14_0.class) {
        if ((getFullBidiCallMethod = TestServiceGrpc_1_14_0.getFullBidiCallMethod) == null) {
          TestServiceGrpc_1_14_0.getFullBidiCallMethod = getFullBidiCallMethod = 
              io.grpc.MethodDescriptor.<io.grpc.testing.compiler.Test.StreamingOutputCallRequest, io.grpc.testing.compiler.Test.StreamingOutputCallResponse>newBuilder()
  ...
  public static io.grpc.MethodDescriptor<io.grpc.testing.compiler.Test.StreamingOutputCallRequest,
    ...
    if ((getHalfBidiCallMethod = TestServiceGrpc_1_14_0.getHalfBidiCallMethod) == null) {
      synchronized (TestServiceGrpc_1_14_0.class) {
        if ((getHalfBidiCallMethod = TestServiceGrpc_1_14_0.getHalfBidiCallMethod) == null) {
          TestServiceGrpc_1_14_0.getHalfBidiCallMethod = getHalfBidiCallMethod = 
              io.grpc.MethodDescriptor.<io.grpc.testing.compiler.Test.StreamingOutputCallRequest, io.grpc.testing.compiler.Test.StreamingOutputCallResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
  ...
  public static io.grpc.MethodDescriptor<io.grpc.testing.compiler.Test.StreamingInputCallRequest,
    ...
    if ((getImportMethod = TestServiceGrpc_1_14_0.getImportMethod) == null) {
      synchronized (TestServiceGrpc_1_14_0.class) {
        if ((getImportMethod = TestServiceGrpc_1_14_0.getImportMethod) == null) {
          TestServiceGrpc_1_14_0.getImportMethod = getImportMethod = 
              io.grpc.MethodDescriptor.<io.grpc.testing.compiler.Test.StreamingInputCallRequest, io.grpc.testing.compiler.Test.StreamingInputCallResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
