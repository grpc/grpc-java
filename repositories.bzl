...
def com_google_protobuf():
    ...
    http_archive(
        ...
        sha256 = "fd70da0383d7ab11b3751e5645372677da14a92f789a5dbb2ea7d4f824074ee6",
        strip_prefix = "protobuf-3.16.3",
        urls = ["https://github.com/protocolbuffers/protobuf/archive/v3.16.3.zip"],
    )
