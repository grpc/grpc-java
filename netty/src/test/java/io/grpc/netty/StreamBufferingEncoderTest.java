 ...
 */
@SuppressWarnings("CheckReturnValue") // netty futures
public class StreamBufferingEncoderTest {
  ...
  public void multipleWritesToActiveStream() {
    ...
    verify(writer, times(1)).writeData(
  ...
  public void sendingGoAwayShouldNotFailStreams() {
    ...
    when(writer.writeHeaders(
            any(ChannelHandlerContext.class), anyInt(), any(Http2Headers.class), anyInt(),
            anyBoolean(), any(ChannelPromise.class)))
        .thenAnswer(successAnswer());
    when(writer.writeHeaders(
            any(ChannelHandlerContext.class), anyInt(), any(Http2Headers.class), anyInt(),
            anyShort(), anyBoolean(), anyInt(), anyBoolean(), any(ChannelPromise.class)))
        .thenAnswer(successAnswer());
