...
The [examples](https://github.com/grpc/grpc-java/tree/v1.55.0/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.55.0/examples/android)
...
```gradle
runtimeOnly 'io.grpc:grpc-netty-shaded:1.55.0'
implementation 'io.grpc:grpc-protobuf:1.55.0'
implementation 'io.grpc:grpc-stub:1.55.0'
...
```gradle
implementation 'io.grpc:grpc-okhttp:1.55.0'
implementation 'io.grpc:grpc-protobuf-lite:1.55.0'
implementation 'io.grpc:grpc-stub:1.55.0'
compileOnly 'org.apache.tomcat:annotations-api:6.0.53' // necessary for Java 9+
```

[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.55.0
