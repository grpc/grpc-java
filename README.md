...
The [examples](https://github.com/grpc/grpc-java/tree/v1.82.4/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.82.4/examples/android)
...
```gradle
runtimeOnly 'io.grpc:grpc-netty-shaded:1.82.4'
implementation 'io.grpc:grpc-protobuf:1.82.4'
implementation 'io.grpc:grpc-stub:1.82.4'
```

For Android client, use `grpc-okhttp` instead of `grpc-netty-shaded` and
`grpc-protobuf-lite` instead of `grpc-protobuf`:
```gradle
implementation 'io.grpc:grpc-okhttp:1.82.4'
implementation 'io.grpc:grpc-protobuf-lite:1.82.4'
implementation 'io.grpc:grpc-stub:1.82.4'
```
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.82.4
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.82.4:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.82.4'
    }
  }
  generateProtoTasks {
    all()*.plugins {
