...
The [examples](https://github.com/grpc/grpc-java/tree/v1.16.0/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.16.0/examples/android)
...
```gradle
compile 'io.grpc:grpc-netty-shaded:1.16.0'
compile 'io.grpc:grpc-protobuf:1.16.0'
compile 'io.grpc:grpc-stub:1.16.0'
```

For Android client, use `grpc-okhttp` instead of `grpc-netty-shaded` and
`grpc-protobuf-lite` instead of `grpc-protobuf`:
```gradle
compile 'io.grpc:grpc-okhttp:1.16.0'
compile 'io.grpc:grpc-protobuf-lite:1.16.0'
compile 'io.grpc:grpc-stub:1.16.0'
```

[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.16.0
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.16.0'
    }
  }
  generateProtoTasks {
    all()*.plugins {
