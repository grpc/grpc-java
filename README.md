...
The [examples](https://github.com/grpc/grpc-java/tree/v1.58.1/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.58.1/examples/android)
...
implementation 'io.grpc:grpc-protobuf-lite:1.58.1'
implementation 'io.grpc:grpc-stub:1.58.1'
compileOnly 'org.apache.tomcat:annotations-api:6.0.53' // necessary for Java 9+
```
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.58.1
