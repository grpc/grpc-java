...
The [examples](https://github.com/grpc/grpc-java/tree/v1.50.1/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.50.1/examples/android)
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.50.1
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.50.1:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
