...
```gradle
compile 'io.grpc:grpc-netty:1.9.1'
compile 'io.grpc:grpc-protobuf:1.9.1'
compile 'io.grpc:grpc-stub:1.9.1'
```
...
```gradle
compile 'io.grpc:grpc-okhttp:1.9.1'
compile 'io.grpc:grpc-protobuf-lite:1.9.1'
compile 'io.grpc:grpc-stub:1.9.1'
```

[the JARs]:
http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.grpc%22%20AND%20v%3A%221.9.1%22
