...
```gradle
compile 'io.grpc:grpc-netty:1.10.1'
...
```gradle
compile 'io.grpc:grpc-okhttp:1.10.1'
compile 'io.grpc:grpc-protobuf-lite:1.10.1'
compile 'io.grpc:grpc-stub:1.10.1'
```

[the JARs]:
http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.grpc%22%20AND%20v%3A%221.10.1%22
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.10.1'
    }
  }
  generateProtoTasks {
    all()*.plugins {
