...
The [examples](https://github.com/grpc/grpc-java/tree/v1.22.2/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.22.2/examples/android)
...
```gradle
compile 'io.grpc:grpc-netty-shaded:1.22.2'
compile 'io.grpc:grpc-protobuf:1.22.2'
compile 'io.grpc:grpc-stub:1.22.2'
```

For Android client, use `grpc-okhttp` instead of `grpc-netty-shaded` and
`grpc-protobuf-lite` instead of `grpc-protobuf`:
```gradle
compile 'io.grpc:grpc-okhttp:1.22.2'
compile 'io.grpc:grpc-protobuf-lite:1.22.2'
compile 'io.grpc:grpc-stub:1.22.2'
```

[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.22.2
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.22.2:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.22.2'
    }
  }
  generateProtoTasks {
    all()*.plugins {
