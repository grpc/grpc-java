...
The [examples](https://github.com/grpc/grpc-java/tree/v1.63.1/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.63.1/examples/android)
...
```gradle
runtimeOnly 'io.grpc:grpc-netty-shaded:1.63.1'
implementation 'io.grpc:grpc-protobuf:1.63.1'
implementation 'io.grpc:grpc-stub:1.63.1'
...
```gradle
implementation 'io.grpc:grpc-okhttp:1.63.1'
implementation 'io.grpc:grpc-protobuf-lite:1.63.1'
implementation 'io.grpc:grpc-stub:1.63.1'
compileOnly 'org.apache.tomcat:annotations-api:6.0.53' // necessary for Java 9+
```
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.63.1
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.63.1:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.63.1'
    }
  }
  generateProtoTasks {
    all()*.plugins {
