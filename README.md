...
```gradle
compile 'io.grpc:grpc-netty:1.6.0'
compile 'io.grpc:grpc-protobuf:1.6.0'
compile 'io.grpc:grpc-stub:1.6.0'
```
...
```gradle
compile 'io.grpc:grpc-okhttp:1.6.0'
compile 'io.grpc:grpc-protobuf-lite:1.6.0'
compile 'io.grpc:grpc-stub:1.6.0'
```

[the JARs]:
http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.grpc%22%20AND%20v%3A%221.6.0%22
