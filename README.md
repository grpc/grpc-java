...
```gradle
compile 'io.grpc:grpc-netty:1.7.1'
compile 'io.grpc:grpc-protobuf:1.7.1'
compile 'io.grpc:grpc-stub:1.7.1'
```
...
```gradle
compile 'io.grpc:grpc-okhttp:1.7.1'
compile 'io.grpc:grpc-protobuf-lite:1.7.1'
compile 'io.grpc:grpc-stub:1.7.1'
```

[the JARs]:
http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.grpc%22%20AND%20v%3A%221.7.1%22
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.7.1:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.7.1'
    }
  }
  generateProtoTasks {
    all()*.plugins {
