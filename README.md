...
The [examples](https://github.com/grpc/grpc-java/tree/v1.27.0/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.27.0/examples/android)
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.27.0
