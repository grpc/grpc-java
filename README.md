...
The [examples](https://github.com/grpc/grpc-java/tree/v1.32.2/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.32.2/examples/android)
...
implementation 'io.grpc:grpc-protobuf:1.32.2'
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.32.2
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.32.2:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
