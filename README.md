...
The [examples](https://github.com/grpc/grpc-java/tree/v1.64.2/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.64.2/examples/android)
...
```gradle
runtimeOnly 'io.grpc:grpc-netty-shaded:1.64.2'
implementation 'io.grpc:grpc-protobuf:1.64.2'
...
[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.64.2
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.64.2'
    }
  }
  generateProtoTasks {
    all()*.plugins {
