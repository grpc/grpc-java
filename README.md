...
```gradle
compile 'io.grpc:grpc-okhttp:1.12.1'
compile 'io.grpc:grpc-protobuf-lite:1.12.1'
compile 'io.grpc:grpc-stub:1.12.1'
```

[the JARs]:
http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.grpc%22%20AND%20v%3A%221.12.1%22
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.12.1:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
