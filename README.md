...
```gradle
compile 'io.grpc:grpc-netty:1.13.0'
compile 'io.grpc:grpc-protobuf:1.13.0'
compile 'io.grpc:grpc-stub:1.13.0'
```
...
```gradle
compile 'io.grpc:grpc-okhttp:1.13.0'
compile 'io.grpc:grpc-protobuf-lite:1.13.0'
compile 'io.grpc:grpc-stub:1.13.0'
```

[the JARs]:
http://search.maven.org/#search%7Cga%7C1%7Cg%3A%22io.grpc%22%20AND%20v%3A%221.13.0%22
  ...
  <plugins>
    <plugin>
      ...
      <configuration>
        ...
        <pluginArtifact>io.grpc:protoc-gen-grpc-java:1.13.0:exe:${os.detected.classifier}</pluginArtifact>
      </configuration>
      <executions>
        <execution>
          <goals>
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.13.0'
    }
  }
  generateProtoTasks {
    all()*.plugins {
