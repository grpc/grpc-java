...
The [examples](https://github.com/grpc/grpc-java/tree/v1.43.3/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.43.3/examples/android)
...
```gradle
implementation 'io.grpc:grpc-netty-shaded:1.43.3'
implementation 'io.grpc:grpc-protobuf:1.43.3'
implementation 'io.grpc:grpc-stub:1.43.3'
...
```gradle
implementation 'io.grpc:grpc-okhttp:1.43.3'
implementation 'io.grpc:grpc-protobuf-lite:1.43.3'
implementation 'io.grpc:grpc-stub:1.43.3'
compileOnly 'org.apache.tomcat:annotations-api:6.0.53' // necessary for Java 9+
```

[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.43.3
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.43.3'
    }
  }
  generateProtoTasks {
    all()*.plugins {
