...
The [examples](https://github.com/grpc/grpc-java/tree/v1.23.1/examples) and the
[Android example](https://github.com/grpc/grpc-java/tree/v1.23.1/examples/android)
...
```gradle
implementation 'io.grpc:grpc-netty-shaded:1.23.1'
implementation 'io.grpc:grpc-protobuf:1.23.1'
implementation 'io.grpc:grpc-stub:1.23.1'
```

For Android client, use `grpc-okhttp` instead of `grpc-netty-shaded` and
`grpc-protobuf-lite` instead of `grpc-protobuf`:
```gradle
implementation 'io.grpc:grpc-okhttp:1.23.1'
implementation 'io.grpc:grpc-protobuf-lite:1.23.1'
implementation 'io.grpc:grpc-stub:1.23.1'
```

[the JARs]:
https://search.maven.org/search?q=g:io.grpc%20AND%20v:1.23.1
...
protobuf {
  ...
  plugins {
    grpc {
      artifact = 'io.grpc:protoc-gen-grpc-java:1.23.1'
    }
  }
  generateProtoTasks {
    all()*.plugins {
