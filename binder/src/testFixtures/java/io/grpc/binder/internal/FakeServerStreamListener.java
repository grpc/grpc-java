...
public final class FakeServerStreamListener extends FakeStreamListener
  ...
  private final List<Object> triggeredEvents = new ArrayList<>();
  ...
  public void triggerEvent(Object event) {
    checkState(!isClosed(), "triggerEvent invoked after closed");
  ...
  /** Returns the list of triggered events in order. */
  public ImmutableList<Object> getTriggeredEvents() {
    return ImmutableList.copyOf(triggeredEvents);
  }
}
