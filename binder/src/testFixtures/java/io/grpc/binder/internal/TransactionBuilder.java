...
/**
 * Builds and dispatches a grpc-binder transaction for unit testing.
 *
 ...
 * allowing unit tests to fluently build transactions, even ones that are valid but never emitted by
 * the grpc-binder implementation under test.
 */
