...
/**
 * Manages life-cycle of Subchannels for {@link XdsLbState}.
 *
...
interface SubchannelPool {
  ...
  /**
   * Takes a {@link Subchannel} from the pool for the given {@code eags} if there is one available.
   * Otherwise, creates and returns a new {@code Subchannel} with the given {@code eags} and {@code
   * defaultAttributes}.
   */
