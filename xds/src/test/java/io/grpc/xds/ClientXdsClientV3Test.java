...
public class ClientXdsClientV3Test extends ClientXdsClientTestBase {
  ...
  public void serverSideListenerFound() throws InvalidProtocolBufferException {
    ...
    call.verifyRequest(ResourceType.LDS, Collections.singletonList(LISTENER_RESOURCE), "0",
        "0000", NODE);
    ...
    // Client sends an ACK LDS request.
    call.verifyRequest(ResourceType.LDS, Collections.singletonList(LISTENER_RESOURCE), "1",
        "0001", NODE);
  ...
  public void serverSideStreamClosedAndRetryRaceWithAddRemoveListenerWatchers() {
    ...
    xdsClient.cancelLdsResourceWatch(LISTENER_RESOURCE, ldsResourceWatcher);
