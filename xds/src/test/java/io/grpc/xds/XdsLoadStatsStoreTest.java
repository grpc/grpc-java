...
public class XdsLoadStatsStoreTest {
  ...
  public void loadReportMatchesSnapshots() {
    ...
    when(counter1.snapshot())
        .thenReturn(new ClientLoadSnapshot(4315, 3421, 23, metrics1),
            new ClientLoadSnapshot(0, 543, 0, Collections.EMPTY_MAP));
    StatsCounter counter2 = mock(StatsCounter.class);
    ...
    when(counter2.snapshot())
        .thenReturn(new ClientLoadSnapshot(41234, 432, 431, metrics2),
            new ClientLoadSnapshot(0, 432, 0, Collections.EMPTY_MAP));
    ...
    ClusterStats expectedReport =
        buildClusterStats(
            Arrays.asList(
                buildUpstreamLocalityStats(LOCALITY1, 4315 - 23, 3421, 23,
                    buildEndpointLoadMetricStatsList(metrics1)),
                buildUpstreamLocalityStats(LOCALITY2, 41234 - 431, 432, 431,
