...
public class CompositeFilterTest {
  ...
  @Test
  public void parseConfigWithTypedStruct() {
    // Use FaultFilter as a real world example
    String typeUrl = "type.googleapis.com/envoy.extensions.filters.http.fault.v3.HTTPFault";

    // Construct a TypedStruct representing a valid HTTPFault
    // fault { delay { fixed_delay { seconds: 1 } percentage { numerator: 100 } } }
    com.github.xds.type.v3.TypedStruct typedStruct = com.github.xds.type.v3.TypedStruct.newBuilder()
        .setTypeUrl(typeUrl)
        .setValue(com.google.protobuf.Struct.newBuilder()
            .putFields("delay", com.google.protobuf.Value.newBuilder()
                .setStructValue(com.google.protobuf.Struct.newBuilder()
                    .putFields("fixed_delay",
                        com.google.protobuf.Value
                            .newBuilder()
                            .setStringValue("1s")
                            .build())
                    .putFields("percentage",
                        com.google.protobuf.Value
                            .newBuilder()
                            .setStructValue(com.google.protobuf.Struct
                                .newBuilder()
                                .putFields("numerator",
                                    com.google.protobuf.Value
                                        .newBuilder()
                                        .setNumberValue(100)
                                        .build())
                                .putFields("denominator",
                                    com.google.protobuf.Value
                                        .newBuilder()
                                        .setStringValue("HUNDRED")
                                        .build())
                                .build())
                            .build())
                    .build())
                    ...
                    .setSinglePredicate(
                        Matcher.MatcherList.Predicate.SinglePredicate
                            ...
                            .setInput(com.github.xds.core.v3.TypedExtensionConfig
                                ...
                                .setName("request_headers")
                                .setTypedConfig(Any
                                    .pack(io.envoyproxy.envoy.type.matcher.v3
                                        .HttpRequestHeaderMatchInput
                                        .newBuilder()
                                        .setHeaderName("foo")
                                        .build()))
    ...
    // Register FaultFilter
    FilterRegistry.getDefaultRegistry().register(new FaultFilter.Provider());
    try {
      ConfigOrError<CompositeFilter.CompositeFilterConfig> result = provider
          .parseFilterConfig(Any.pack(proto));
      // We expect success now that FaultFilter handles Struct
      assertThat(result.errorDetail).isNull();
      assertThat(result.config).isNotNull();
    } finally {
      FilterRegistry.getDefaultRegistry().deregister(new FaultFilter.Provider());
    }
  }
}
