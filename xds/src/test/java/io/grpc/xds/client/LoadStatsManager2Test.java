...
public class LoadStatsManager2Test {
  ...
  public void recordAndGetReport() {
    ...
    assertThat(loadStats1.loadMetricStatsMap().get("named_metrics.named1")
        .totalMetricValue()).isWithin(TOLERANCE).of(3.14159 + 1.618 + 99 - 97.23);
    assertThat(
        loadStats1.loadMetricStatsMap().get("named_metrics.named2")
            .numRequestsFinishedWithMetric()).isEqualTo(1L);
    assertThat(loadStats1.loadMetricStatsMap().get("named_metrics.named2")
        .totalMetricValue()).isWithin(TOLERANCE).of(-2.718);
    ...
    assertThat(
        loadStats2.loadMetricStatsMap().get("named_metrics.named3")
            .numRequestsFinishedWithMetric()).isEqualTo(1L);
    assertThat(loadStats2.loadMetricStatsMap().get("named_metrics.named3")
        .totalMetricValue()).isWithin(TOLERANCE).of(0.0009);
