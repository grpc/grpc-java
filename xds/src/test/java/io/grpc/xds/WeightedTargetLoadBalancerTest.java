...
import io.grpc.xds.WeightedTargetLoadBalancer.WeightedLbConfig;
...
public class WeightedTargetLoadBalancerTest {
  ...
  private final WeightedLbConfig weightedLbConfig0 =
      new WeightedLbConfig(weights[0], "foo_policy", configs[0]);
  private final WeightedLbConfig weightedLbConfig1 =
      new WeightedLbConfig(weights[1], "bar_policy", configs[1]);
  private final WeightedLbConfig weightedLbConfig2 =
      new WeightedLbConfig(weights[2], "bar_policy", configs[2]);
  private final WeightedLbConfig weightedLbConfig3 =
      new WeightedLbConfig(weights[3], "foo_policy", configs[3]);
  ...
  public void setUp() {
    ...
    weightedTargetLb = new WeightedTargetLoadBalancer(
        helper,
        ImmutableList.of(
            // {foo, 10, config0}, {bar, 20, config1}, {bar, 30, config2}, {foo, 40, config3}
            weightedLbConfig0, weightedLbConfig1, weightedLbConfig2, weightedLbConfig3),
        lbRegistry,
        pickerFactory);
