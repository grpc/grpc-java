...
public class XdsClientImplTest {
  ...
  public void ldsResponseWithoutMatchingResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(NODE, "", TARGET_AUTHORITY, XdsClientImpl.ADS_TYPE_URL_LDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "0", TARGET_AUTHORITY, XdsClientImpl.ADS_TYPE_URL_LDS, "0000")));
  ...
  public void failToFindVirtualHostInLdsResponseInLineRouteConfig() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", TARGET_AUTHORITY, XdsClientImpl.ADS_TYPE_URL_LDS, "")));
    assertThat(fakeClock.getPendingTasks(LDS_RESOURCE_FETCH_TIMEOUT_TASK_FILTER)).hasSize(1);
  ...
  public void rdsResponseWithoutMatchingResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "route-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "0", "route-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS, "0000")));
  ...
  public void notifyUpdatedResources() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", TARGET_AUTHORITY, XdsClientImpl.ADS_TYPE_URL_LDS, "0001")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "2", TARGET_AUTHORITY, XdsClientImpl.ADS_TYPE_URL_LDS, "0002")));

    // Client sends an (first) RDS request.
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "some-route-to-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "0", "some-route-to-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS,
            "0000")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", "some-route-to-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS,
            "0001")));
  ...
  public void waitRdsResponsesForRequestedResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", "route-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS, "0001")));
  ...
  public void updateRdsRequestResourceWhileInitialResourceFetchInProgress() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "route-bar.googleapis.com", XdsClientImpl.ADS_TYPE_URL_RDS, "")));
  ...
  public void cdsResponseWithoutMatchingResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "0", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "0000")));
  ...
  public void cdsResponseWithMatchingResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "0001")));
  ...
  public void addRemoveClusterWatchers() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", "cluster-bar.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "0001")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "2", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "0002")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "3", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "0003")));
  }
  ...
  public void edsResponseWithoutMatchingResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "0", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "0000")));
  ...
  public void edsResponseWithMatchingResource() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", "cluster-foo.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "0001")));
  ...
  public void addRemoveEndpointWatchers() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "1", "cluster-bar.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "0001")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "2", "cluster-bar.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "0002")));
  ...
  public void streamClosedAndRetry() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "cluster.googleapis.com", XdsClientImpl.ADS_TYPE_URL_CDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "cluster.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "")));
  ...
  public void streamClosedAndRetryRaceWithAddingAndRemovingWatchers() {
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", ImmutableList.<String>of(), XdsClientImpl.ADS_TYPE_URL_EDS, "")));
    ...
    verify(requestObserver).onNext(eq(
        buildDiscoveryRequest(
            NODE, "", "cluster2.googleapis.com", XdsClientImpl.ADS_TYPE_URL_EDS, "")));
