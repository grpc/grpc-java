...
import io.grpc.xds.ExtAuthzConfigParser;
...
public class CheckRequestBuilderTest {
  ...
  private ExtAuthzConfig buildExtAuthzConfig(ListStringMatcher allowed,
    ...
    BootstrapInfo bootstrapInfo =
        CommonBootstrapperTestUtils.buildBootStrap(
            Collections.singletonList("test-cluster"));
    return ExtAuthzConfigParser.parse(
        builder.build(), bootstrapInfo, bootstrapInfo.servers().get(0));
  }
}
