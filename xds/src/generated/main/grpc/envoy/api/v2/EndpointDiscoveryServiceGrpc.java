...
public final class EndpointDiscoveryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getStreamEndpointsMethod;
  ...
  public static io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getStreamEndpointsMethod() {
    io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest, envoy.api.v2.Discovery.DiscoveryResponse> getStreamEndpointsMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getFetchEndpointsMethod;
  ...
  public static io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getFetchEndpointsMethod() {
    io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest, envoy.api.v2.Discovery.DiscoveryResponse> getFetchEndpointsMethod;
  ...
  public static abstract class EndpointDiscoveryServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryRequest> streamEndpoints(
    ...
    /**
     */
    public void fetchEndpoints(envoy.api.v2.Discovery.DiscoveryRequest request,
        io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryResponse> responseObserver) {
  ...
  public static final class EndpointDiscoveryServiceBlockingStub extends io.grpc.stub.AbstractStub<EndpointDiscoveryServiceBlockingStub> {
    ...
    /**
     */
    public envoy.api.v2.Discovery.DiscoveryResponse fetchEndpoints(envoy.api.v2.Discovery.DiscoveryRequest request) {
  ...
  public static final class EndpointDiscoveryServiceFutureStub extends io.grpc.stub.AbstractStub<EndpointDiscoveryServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<envoy.api.v2.Discovery.DiscoveryResponse> fetchEndpoints(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FETCH_ENDPOINTS:
          serviceImpl.fetchEndpoints((envoy.api.v2.Discovery.DiscoveryRequest) request,
              (io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class EndpointDiscoveryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return envoy.api.v2.Eds.getDescriptor();
    }
