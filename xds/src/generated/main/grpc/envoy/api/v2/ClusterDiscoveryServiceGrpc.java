...
public final class ClusterDiscoveryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getStreamClustersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "StreamClusters",
      requestType = envoy.api.v2.Discovery.DiscoveryRequest.class,
      responseType = envoy.api.v2.Discovery.DiscoveryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getStreamClustersMethod() {
    io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest, envoy.api.v2.Discovery.DiscoveryResponse> getStreamClustersMethod;
      ...
      synchronized (ClusterDiscoveryServiceGrpc.class) {
        if ((getStreamClustersMethod = ClusterDiscoveryServiceGrpc.getStreamClustersMethod) == null) {
          ClusterDiscoveryServiceGrpc.getStreamClustersMethod = getStreamClustersMethod = 
              io.grpc.MethodDescriptor.<envoy.api.v2.Discovery.DiscoveryRequest, envoy.api.v2.Discovery.DiscoveryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "envoy.api.v2.ClusterDiscoveryService", "StreamClusters"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  envoy.api.v2.Discovery.DiscoveryRequest.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<envoy.api.v2.Discovery.IncrementalDiscoveryRequest,
      envoy.api.v2.Discovery.IncrementalDiscoveryResponse> getIncrementalClustersMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "IncrementalClusters",
      requestType = envoy.api.v2.Discovery.IncrementalDiscoveryRequest.class,
      responseType = envoy.api.v2.Discovery.IncrementalDiscoveryResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<envoy.api.v2.Discovery.IncrementalDiscoveryRequest,
      envoy.api.v2.Discovery.IncrementalDiscoveryResponse> getIncrementalClustersMethod() {
    io.grpc.MethodDescriptor<envoy.api.v2.Discovery.IncrementalDiscoveryRequest, envoy.api.v2.Discovery.IncrementalDiscoveryResponse> getIncrementalClustersMethod;
      ...
      synchronized (ClusterDiscoveryServiceGrpc.class) {
        if ((getIncrementalClustersMethod = ClusterDiscoveryServiceGrpc.getIncrementalClustersMethod) == null) {
          ClusterDiscoveryServiceGrpc.getIncrementalClustersMethod = getIncrementalClustersMethod = 
              io.grpc.MethodDescriptor.<envoy.api.v2.Discovery.IncrementalDiscoveryRequest, envoy.api.v2.Discovery.IncrementalDiscoveryResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "envoy.api.v2.ClusterDiscoveryService", "IncrementalClusters"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  envoy.api.v2.Discovery.IncrementalDiscoveryRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  envoy.api.v2.Discovery.IncrementalDiscoveryResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getFetchClustersMethod;
  ...
  public static io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest,
      envoy.api.v2.Discovery.DiscoveryResponse> getFetchClustersMethod() {
    io.grpc.MethodDescriptor<envoy.api.v2.Discovery.DiscoveryRequest, envoy.api.v2.Discovery.DiscoveryResponse> getFetchClustersMethod;
  ...
  public static abstract class ClusterDiscoveryServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryRequest> streamClusters(
        io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getStreamClustersMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.IncrementalDiscoveryRequest> incrementalClusters(
        io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.IncrementalDiscoveryResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getIncrementalClustersMethod(), responseObserver);
    }

    /**
     */
    public void fetchClusters(envoy.api.v2.Discovery.DiscoveryRequest request,
        io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                envoy.api.v2.Discovery.DiscoveryRequest,
                envoy.api.v2.Discovery.DiscoveryResponse>(
                  this, METHODID_STREAM_CLUSTERS)))
          .addMethod(
            getIncrementalClustersMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                envoy.api.v2.Discovery.IncrementalDiscoveryRequest,
                envoy.api.v2.Discovery.IncrementalDiscoveryResponse>(
  ...
  public static final class ClusterDiscoveryServiceBlockingStub extends io.grpc.stub.AbstractStub<ClusterDiscoveryServiceBlockingStub> {
    ...
    /**
     */
    public envoy.api.v2.Discovery.DiscoveryResponse fetchClusters(envoy.api.v2.Discovery.DiscoveryRequest request) {
  ...
  public static final class ClusterDiscoveryServiceFutureStub extends io.grpc.stub.AbstractStub<ClusterDiscoveryServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<envoy.api.v2.Discovery.DiscoveryResponse> fetchClusters(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_FETCH_CLUSTERS:
          serviceImpl.fetchClusters((envoy.api.v2.Discovery.DiscoveryRequest) request,
              (io.grpc.stub.StreamObserver<envoy.api.v2.Discovery.DiscoveryResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ClusterDiscoveryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return envoy.api.v2.Cds.getDescriptor();
    }
