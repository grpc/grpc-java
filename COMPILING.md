...
```
.\gradlew install ^
    -PvcProtobufInclude=C:\path\to\protobuf-3.3.0\src ^
    -PvcProtobufLibs=C:\path\to\protobuf-3.3.0\vsprojects\Release ^
    -PtargetArch=x86_32
```
...
```
vcProtobufInclude=C:\\path\\to\\protobuf-3.3.0\\src
vcProtobufLibs=C:\\path\\to\\protobuf-3.3.0\\vsprojects\\Release
targetArch=x86_32
```
