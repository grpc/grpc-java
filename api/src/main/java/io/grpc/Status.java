...
public final class Status {
   ...
   */
  public static Status convertServerStatus(Status status) {
    if (status == null) {
      return  null;
    }
    ...
    switch (status.getCode()) {
      ...
      case NOT_FOUND:
        ...
        break;
      case ABORTED:
        newCode = Status.Code.UNKNOWN;
        break;
      default:
        return status;
    }

    return newCode.toStatus().withCause(status.getCause()).withDescription(status.getDescription());
  }
