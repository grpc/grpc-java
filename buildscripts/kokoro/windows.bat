...
(cmd.exe /C "%WORKSPACE%\gradlew.bat assemble" || cmd.exe /C "%WORKSPACE%\gradlew.bat assemble " || cmd.exe /C "%WORKSPACE%\gradlew.bat assemble") && cmd.exe /C "%WORKSPACE%\gradlew.bat clean"
