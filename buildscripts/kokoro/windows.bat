...
(cmd.exe /C "%WORKSPACE%\gradlew.bat dependencies" || cmd.exe /C "%WORKSPACE%\gradlew.bat dependencies " || cmd.exe /C "%WORKSPACE%\gradlew.bat dependencies") && cmd.exe /C "%WORKSPACE%\gradlew.bat clean"
