...
public interface CallCredentials {
  ...
  public static final Key<SecurityLevel> ATTR_SECURITY_LEVEL =
      Key.of("io.grpc.CallCredentials.securityLevel", SecurityLevel.class);
   ...
   */
  @ExperimentalApi("https://github.com/grpc/grpc-java/issues/1914")
  public static final Key<String> ATTR_AUTHORITY =
      Key.of("io.grpc.CallCredentials.authority", String.class);
