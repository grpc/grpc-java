...
@ThreadSafe
final class InternalSubchannelExperimental implements
  ...
  InternalSubchannelExperimental(List<EquivalentAddressGroup> addressGroups, String authority,
    ...
    this.addressGroups = Collections.unmodifiableList(new ArrayList<>(addressGroups));;
