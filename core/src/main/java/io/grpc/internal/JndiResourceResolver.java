...
/**
 * JndiResourceResolver resolves additional records for the DnsNameResolver.
 */
final class JndiResourceResolver implements DnsNameResolver.ResourceResolver {
  ...
  public List<String> resolveTxt(String serviceConfigHostname) throws NamingException {
    ...
    List<String> serviceConfigTxtRecords = new ArrayList<String>(serviceConfigRawTxtRecords.size());
