...
/**
 * A {@link RoundRobinLoadBalancer} that provides round-robin load-balancing over the {@link
 * EquivalentAddressGroup}s from the {@link NameResolver}.
 */
final class RoundRobinLoadBalancerImpl extends RoundRobinLoadBalancer {

  RoundRobinLoadBalancerImpl(Helper helper) {
    super(helper);
  }
