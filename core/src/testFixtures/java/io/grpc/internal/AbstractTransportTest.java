...
public abstract class AbstractTransportTest {
  ...
  public void frameAfterRstStreamShouldNotBreakClientChannel() throws Exception {
    ...
    stream.flush();
    serverStreamCreation.stream.writeHeaders(new Metadata(), shouldServerFlushHeaders());
  ...
  public void openStreamPreventsTermination() throws Exception {
    ...
    serverStream.writeHeaders(new Metadata(), shouldServerFlushHeaders());
  ...
  public void basicStream() throws Exception {
    ...
    serverStream.writeHeaders(serverHeaders, shouldServerFlushHeaders());
  ...
  public void interactionsAfterServerStreamCloseAreNoops() throws Exception {
    ...
    server.stream.writeHeaders(new Metadata(), shouldServerFlushHeaders());
  ...
  public void clientChecksInboundMetadataSize_header() throws Exception {
    ...
    serverStreamCreation.stream.request(1);
    serverStreamCreation.stream.writeHeaders(tooLargeMetadata, shouldServerFlushHeaders());
  ...
  private boolean shouldServerFlushHeaders() {
    return !methodDescriptor.getType().serverSendsOneMessage();
  }
