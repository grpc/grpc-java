...
/** Interop test server that implements the PSM security testing service. */
public final class XdsSecurityTestServer {
  ...
  private static Logger logger = Logger.getLogger(XdsSecurityTestServer.class.getName());
  ...
  public static void main(String[] args) throws Exception {
    final XdsSecurityTestServer server = new XdsSecurityTestServer();
  ...
  private void parseArgs(String[] args) {
    ...
    if (usage) {
      XdsSecurityTestServer s = new XdsSecurityTestServer();
      System.err.println(
          "Usage: [ARGS...]"
              + "\n"
